...
import { childMixin, safeScopedSlotMixin } from '@/libs/v-calendar/src/utils/mixins';
import { arrayHasItems } from '@/libs/v-calendar/src/utils/helpers';
import { last, get, defaults } from '@/libs/v-calendar/src/utils/_';
...
export default {
  ...
  methods: {
    ...
    processDot({ key, dot }, { isDate, onStart, onEnd }, { dots }) {
      ...
      if (this.isDeleteMode && key === "today") {
        return;
      }
