import { format, parse } from '@/libs/v-calendar/src/utils/fecha';
import defaultLocales from '@/libs/v-calendar/src/utils/defaults/locales';
import { addPages, pageForDate } from '@/libs/v-calendar/src/utils/helpers';
import {
  isDate,
  isNumber,
  isString,
